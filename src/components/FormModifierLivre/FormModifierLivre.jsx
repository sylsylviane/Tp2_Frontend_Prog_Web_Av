...
function FormModifierLivre() {
  ...
  async function onSubmit(e) {
    ...
    if (formRef.current.checkValidity()) {
      ...
      console.log(objDonnees.body);

      const reponse = await fetch(`${url}/livres/${id}`, objDonnees);
      console.log(donneesLivre);
  ...
  return (
    ...
    >
      ...
      <div className="mt-6 flex items-center justify-center gap-x-6">
        ...
        <button className="rounded-md bg-yellow-700 px-3 py-2 text-sm font-semibold text-gray-700 shadow-xs hover:bg-red-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-400">
          Sauvegarder
        </button>
